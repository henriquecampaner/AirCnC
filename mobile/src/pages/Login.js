...
import {KeyboardAvoidingView, Platform, AsyncStorage, View,Text, Image, StyleSheet, TextInput, TouchableOpacity} from 'react-native';
...
export default function Login({navigation}) {
    ...
    <KeyboardAvoidingView enabled={true} behavior="padding" style={styles.container}>
        ...
        <View style={styles.form}>
            ...
            <TextInput
                style={styles.input}
                placeholder="Techs that you want"
                placeholderTextColor="#999"
